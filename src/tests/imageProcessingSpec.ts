...
import { serveImage, thumbnailExists, createImage, findImage, thumbPath  } from '../imageProcessing';
...
describe('imageProcessing', () => {
    ...
    describe('createImage', () => {
        it('should create a thumbnail', async () => {
            emptyThumbDir();
            await createImage(imageFile, {width: 200, height: 100, fit:'fill'}, 'png', thumbFile);
